...
LITESPARK = {
    'amd': {
        'name': 'AMD EPYC 9R14',
        'threads': [1, 2, 4, 8],
        'pp128': [38.30, 74.76, 140.90, 244.33],
        'tg128': [4.72, 6.78, 8.31, 8.93]
    },
    'intel': {
        'name': 'Intel Xeon 8488C',
        'threads': [1, 2, 4, 8],
        'pp128': [52.06, 97.40, 159.57, 126.42],
        'tg128': [3.08, 5.25, 8.22, 7.06]
    },
    'arm': {
        'name': 'Apple M4',
        'threads': [1, 2, 4, 8],
        'pp128': [23.93, 40.92, 64.97, 70.29],
        'tg128': [6.55, 6.31, 6.77, 6.96]
    }
}
